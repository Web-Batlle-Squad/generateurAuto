    ...
    for (int j = 0; j < Y; j++) {
        for (int i = 0; i < X; i++) {
            if (unitsArray[(j * X) + i] == 1 || unitsArray[(j * X) + i] == 2 || unitsArray[(j * X) + i] == 3) {
                ...
                allyUnitsTab[allyUnitsNumber - 1].classe = unitsArray[(j * X) + i];
    ...
    for (int j = 0; j < Y; j++) {
        for (int i = 0; i < X; i++) {
            if (unitsArray[(j * X) + i] == 4 || unitsArray[(j * X) + i] == 5 || unitsArray[(j * X) + i] == 6) {
                ...
                enemyUnitsTab[enemiesNumber - 1].classe = unitsArray[(j * X) + i];
            }
        }
    }
    if (enemiesNumber == 0) {
                ...
                if (unitsArray[(tree[previousPosition].y - 1) * X + tree[previousPosition].x] != 7 && tree[previousPosition].priority < moveNber) {
                    ...
                    for (int i = 0; i < enemiesNumber; i++) {
                        ...
                        if (tree[currentPosition].x == enemyUnitsTab[i].x && tree[currentPosition].y == enemyUnitsTab[i].y && tree[currentPosition].unit != enemyUnitsTab[i].unit) {
                            // triangle des forces
                            if ((allyUnitsTab[(int)tree[currentPosition].unit].classe == 1 && enemyUnitsTab[i].classe == 5) || (allyUnitsTab[(int)tree[currentPosition].unit].classe == 2 && enemyUnitsTab[i].classe == 6) || (allyUnitsTab[(int)tree[currentPosition].unit].classe == 3 && enemyUnitsTab[i].classe == 4)) {
